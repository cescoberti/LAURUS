  ...
  return (
    <div className="min-h-screen">
      ...
      <main className="mx-auto max-w-3xl px-6 py-8">
        <h1 className="text-2xl font-bold text-ink-900">Inviti</h1>
        <p className="mt-1 text-sm text-ink-500">
          Genera un link di invito da condividere con un nuovo membro. Il link resta valido 30 giorni e
        ...
        <form action={generateInviteAction} className="mt-6 flex flex-col gap-3 rounded-xl border border-slate-200/70 bg-white p-4 sm:flex-row sm:items-end">
          <div className="flex-1">
            <label className="text-sm font-medium text-ink-900">Email (opzionale)</label>
            <input
              type="email"
              name="email"
